...
public:
    ...
    void retranslateUi(QDialog *QgsFieldCalculatorBase)
    {
        ...
        mOutputFieldWidthLabel->setText(QApplication::translate("QgsFieldCalculatorBase", "Output field length", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        mOutputFieldWidthSpinBox->setToolTip(QApplication::translate("QgsFieldCalculatorBase", "Length of complete output. For example 123,456 means 6 as field length.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
