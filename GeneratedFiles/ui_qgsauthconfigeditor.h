...
public:
    ...
    void setupUi(QWidget *QgsAuthConfigEditor)
    {
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/themes/default/symbologyEdit.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    {
        QgsAuthConfigEditor->setWindowTitle(QApplication::translate("QgsAuthConfigEditor", "Edit Authentication Configurations", 0, QApplication::UnicodeUTF8));
        btnAddConfig->setText(QString());
        btnRemoveConfig->setText(QString());
        btnEditConfig->setText(QString());
        btnAuthUtilities->setText(QString());
        lblAuthConfigDb->setText(QApplication::translate("QgsAuthConfigEditor", "Authentication Configurations", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
