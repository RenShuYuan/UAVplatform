    ...
    , mFieldsPropertiesDialog( nullptr )
{
  ...
  if ( layer->hasGeometryType() )
  {
    ...
    layout->setMargin( 0 );
    labelingDialog = new QgsLabelingWidget( layer, UavMain::instance()->mapCanvas(), labelingFrame );
  ...
  connect( this, SIGNAL( toggleEditing( QgsMapLayer* ) ), UavMain::instance(), SLOT( toggleEditing( QgsMapLayer* ) ) );
...
void QgsVectorLayerProperties::updateSymbologyPage()
{
  ...
  if ( layer->rendererV2() )
  {
    ...
    mRendererDialog->setMapCanvas( UavMain::instance()->mapCanvas() );
