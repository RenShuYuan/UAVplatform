...
QgsComposer::QgsComposer( UAVplatform *qgis, const QString& title )
    : QMainWindow()
    , mTitle( title )
    , mQgis( qgis )
    , mPrinter( nullptr )
    ...
    , mAtlasFeatureAction( nullptr )
{
  ...
  shapeToolButton->setIcon( core::getThemeIcon( "mActionAddBasicShape.svg" ) );
  ...
  mActionCut->setIcon( core::getThemeIcon( "mActionEditCut.png" ) );
  ...
  mActionCopy->setIcon( core::getThemeIcon( "mActionEditCopy.png" ) );
  ...
  mActionPaste->setIcon( core::getThemeIcon( "mActionEditPaste.png" ) );
  ...
  shapeMenu->setIcon( core::getThemeIcon( "mActionAddBasicShape.png" ) );
