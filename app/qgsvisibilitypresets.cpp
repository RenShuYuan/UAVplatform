    ...
    : mMenu( new QMenu )
{
  ...
  mMenu->addAction( UavMain::instance()->actionShowAllLayers() );
  mMenu->addAction( UavMain::instance()->actionHideAllLayers() );
  mMenu->addAction( UavMain::instance()->actionShowSelectedLayers() );
  mMenu->addAction( UavMain::instance()->actionHideSelectedLayers() );
  mMenu->addSeparator();
...
{
  QgsLayerTreeModel* model = UavMain::instance()->layerTreeView()->layerTreeModel();
...
QStringList QgsVisibilityPresets::orderedPresetVisibleLayers( const QString& name ) const
{
  ...
  QgsLayerTreeMapCanvasBridge* bridge = UavMain::instance()->layerTreeCanvasBridge();
