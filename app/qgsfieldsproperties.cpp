...
#include "app/qgsaddtaborgroup.h"
    ...
    , mRelationsList( nullptr )
{
  ...
  mAddAttributeButton->setIcon( uavCore::getThemeIcon( "mActionNewAttribute.png" ) );
  mDeleteAttributeButton->setIcon( uavCore::getThemeIcon( "mActionDeleteAttribute.png" ) );
  mToggleEditingButton->setIcon( uavCore::getThemeIcon( "mActionToggleEditing.svg" ) );
  mCalculateFieldButton->setIcon( uavCore::getThemeIcon( "mActionCalculateField.png" ) );
...
void QgsFieldsProperties::setRow( int row, int idx, const QgsField& field )
{
  ...
  switch ( mLayer->fields().fieldOrigin( idx ) )
  {
    case QgsFields::OriginExpression:
      dataItem->setIcon( uavCore::getThemeIcon( "mIconExpression.svg" ) );
      break;

    case QgsFields::OriginJoin:
      dataItem->setIcon( uavCore::getThemeIcon( "propertyicons/join.png" ) );
      break;
  ...
  if ( mLayer->fields().fieldOrigin( idx ) == QgsFields::OriginExpression )
  {
    ...
    editExpressionButton->setIcon( uavCore::getThemeIcon( "mIconExpression.svg" ) );
