...
{
  resultsDialog()->clear();
  connect( this, SIGNAL( identifyProgress( int, int ) ), UavMain::instance(), SLOT( showProgress( int, int ) ) );
  connect( this, SIGNAL( identifyMessage( QString ) ), UavMain::instance(), SLOT( showStatusMessage( QString ) ) );
  ...
  disconnect( this, SIGNAL( identifyProgress( int, int ) ), UavMain::instance(), SLOT( showProgress( int, int ) ) );
  disconnect( this, SIGNAL( identifyMessage( QString ) ), UavMain::instance(), SLOT( showStatusMessage( QString ) ) );

  if ( results.isEmpty() )
  {
    resultsDialog()->clear();
    UavMain::instance()->statusBar()->showMessage( tr( "No features at this position found." ) );
  }
  else
  {
