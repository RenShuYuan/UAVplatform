...
#include "core/raster/qgsrasterrendererregistry.h"
    ...
    , mHistogramWidget( nullptr )
{
  ...
  QIcon myPyramidPixmap( uavCore::getThemeIcon( "mIconPyramid.png" ) );
  QIcon myNoPyramidPixmap( uavCore::getThemeIcon( "mIconNoPyramid.png" ) );

  pbnAddValuesManually->setIcon( uavCore::getThemeIcon( "symbologyAdd.svg" ) );
  pbnAddValuesFromDisplay->setIcon( uavCore::getThemeIcon( "mActionContextHelp.png" ) );
  pbnRemoveSelectedRow->setIcon( uavCore::getThemeIcon( "symbologyRemove.svg" ) );
  pbnDefaultValues->setIcon( uavCore::getThemeIcon( "mActionOpenTable.svg" ) );
  pbnImportTransparentPixelValues->setIcon( uavCore::getThemeIcon( "mActionFileOpen.svg" ) );
  pbnExportTransparentPixelValues->setIcon( uavCore::getThemeIcon( "mActionFileSave.svg" ) );
...
// Alpha band is set in sync()
  ...
  mResetColorRenderingBtn->setIcon( uavCore::getThemeIcon( "mActionUndo.png" ) );
